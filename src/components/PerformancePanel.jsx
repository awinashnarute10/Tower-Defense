...
export default function PerformancePanel({ snapshot, lab, stressConfig, onSetStressConfig, onApplyPreset, onExit }) {
      ...
      {lab && (
        <>
          ...
          <div className="text-[8px] opacity-60 leading-relaxed">
            Baseline disables the spatial grid (linear enemy scan per tower), target
            caching (re-acquire every frame), and sprite caching (rebuild gradients
